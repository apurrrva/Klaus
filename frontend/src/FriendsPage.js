...
import './FriendsPage.css'; // Updated import
        ...
        <div className="connect-section">
          ...
          <div className="connect-buttons">
            <button
              ...
              className="connect-button instagram"
            >
              <span className="connect-emoji">📷</span> Instagram
            </button>
            <button
              onClick={() => handleConnectSocial("Facebook")}
              className="connect-button facebook"
            >
              <span className="connect-emoji">📘</span> Facebook
            </button>
            <button
              onClick={() => handleConnectSocial("Contacts")}
              className="connect-button contacts"
            >
            ...
            filteredFriends.map((friend) => (
              <div key={friend.id} className="friend-card">
                <div className="friend-avatar-container">
                  ...
                  />
                  <div
                    className={`status-indicator ${friend.status === "online" ? "online" : "offline"}`}
                  ></div>
                </div>
        ...
        <div className="fixed-nav-container">
          <div className="card-nav">
            ...
            <div className="card-nav-item active" onClick={handleProfilesPage}>
              <div className="card-nav-icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" fill="white">
                  <path d="M12,12A6,6,0,1,0,6,6,6.006,6.006,0,0,0,12,12ZM12,2_core-js/modules/es.array.concat.js:4,4,0,1,1,8,6,4,4,0,1,1,12,2Z" />
